...
import { grokBuildProvider, grokBuildScaffoldProvider } from "./grok-build.js";
...
const HARNESSES: Map<string, HarnessEntry> = new Map([
  ...
  [
    "grok-build",
    {
      review: grokBuildProvider as ReviewAgentFactory,
      scaffold: grokBuildScaffoldProvider as ScaffoldAgentFactory,
    },
  ],
]);
