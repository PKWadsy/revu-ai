...
program
  ...
  .option("--harness <name>", "agent harness (default: claude-code; also: opencode, grok-build)")
  .option("--provider <name>", "AI provider id (opencode harness only — e.g. xai, google, anthropic)")
  .option("--model <id>", "model id passed to harness (grok-build default: grok-build / Grok 4.5)")
